...
class DatasetEvaluator:
    ...
    def process(self, inputs, outputs):
        ...
        .. code-block:: python
            ...
            for input_, testing_output in zip(inputs, outputs):
                # do evaluation on single input/testing_output pair
                ...
    ...
    def evaluate(self):
        """
        Evaluate/summarize the performance, after processing all input/testing_output pairs.
