...
# Set this to -1 to use the same number of testing_output channels as input channels.
...
# Misc options
# ---------------------------------------------------------------------------- #
# Directory where testing_output files are written
_C.OUTPUT_DIR = "./testing_output"
