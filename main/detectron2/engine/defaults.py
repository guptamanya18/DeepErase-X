...
def default_setup(cfg, args):
    ...
    3. Backup the config to the testing_output directory
    ...
    if comm.is_main_process() and output_dir:
        ...
        # config.yaml in testing_output directory
...
class DefaultPredictor:
    ...
    4. Take one input image and produce a single testing_output, instead of a batch.
    ...
    def __call__(self, original_image):
        ...
        Returns:
            predictions (dict):
                the testing_output of the model for one image only.
