...
class StandardRPNHead(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            conv_dims (list[int]): a list of integers representing the testing_output channels
                of N conv layers. Set it to -1 to use the same number of testing_output channels
                as input channels.
        """
        super().__init__()
        ...
        if len(conv_dims) == 1:
            ...
            for k, conv_dim in enumerate(conv_dims):
                ...
                if out_channels <= 0:
                    raise ValueError(
                        f"Conv testing_output channels should be greater than 0. Got {out_channels}"
                    )
