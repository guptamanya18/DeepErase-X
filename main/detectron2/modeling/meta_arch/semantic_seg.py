            ...
            batched_inputs: a list, batched outputs of :class:`DatasetMapper`.
                ...
                For now, each item in the list is a dict that contains:
                   ...
                   * Other information that's included in the original dicts, such as:
                     "height", "width" (int): the testing_output resolution of the model (may be different
                     from input resolution), used in inference.


        Returns:
            list[dict]:
              Each dict is the testing_output for one input image.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            conv_dims: number of testing_output channels for the intermediate conv layers.
