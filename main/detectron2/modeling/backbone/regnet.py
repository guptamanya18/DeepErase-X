...
class AnyStage(nn.Module):
    """AnyNet stage (sequence of blocks w/ the same testing_output shape)."""
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            stem_width (int): The number of testing_output channels that the stem produces.
            ...
            widths (list[int]): For each stage, the number of testing_output channels of each block.
            ...
            bottleneck_ratios (list[float]): For each stage, the ratio of the number of bottleneck
                channels to the number of block input channels (or, equivalently, testing_output channels),
            ...
            out_features (list[str]): name of the layers whose outputs should
                ...
                the stem. If None, will return the testing_output of the last layer.
        """
        super().__init__()
        ...
        *,
        ...
        Args:
            ...
            bottleneck_ratio (float): The ratio of the number of bottleneck channels to the number
                of block input channels (or, equivalently, testing_output channels), if the block uses a
                bottleneck.
