...
class WindowAttention(nn.Module):
    ...
    Args:
        ...
        proj_drop (float, optional): Dropout ratio of testing_output. Default: 0.0
    """
...
class PatchEmbed(nn.Module):
    ...
    Args:
        ...
        embed_dim (int): Number of linear projection testing_output channels. Default: 96.
...
class SwinTransformer(Backbone):
    ...
    def __init__(
        ...
        # add a norm layer for each testing_output
