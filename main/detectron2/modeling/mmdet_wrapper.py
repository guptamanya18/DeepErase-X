...
class MMDetBackbone(Backbone):
    ...
    testing_output in detectron2's convention, so it can be used in place of detectron2
    backbones.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            output_shapes: shape for every testing_output of the backbone (or neck, if given).
                stride and channels are often needed.
            output_names: names for every testing_output of the backbone (or neck, if given).
...
class MMDetDetector(nn.Module):
    ...
    Input/testing_output formats of this class follow detectron2's convention, so a
