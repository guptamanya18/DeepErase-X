...
class ResizeShortestEdge(Augmentation):
    ...
    def get_output_shape(
        ...
        """
        Compute the testing_output size given input size and target short edge length.
        """
        h, w = oldh, oldw
...
class ResizeScale(Augmentation):
    ...
    def _get_resize(self, image: np.ndarray, scale: float) -> Transform:
        ...
        # Compute actual rescaling applied to input image and testing_output size.
...
class RandomExtent(Augmentation):
    ...
    in which case they will be set to zeros (i.e. black). The size of the testing_output
    ...
    def __init__(self, scale_range, shift_range):
        """
        Args:
            output_size (h, w): Dimensions of testing_output image
            scale_range (l, h): Range of input-to-testing_output size scaling factor
