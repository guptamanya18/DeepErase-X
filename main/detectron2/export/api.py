...
class Caffe2Model(nn.Module):
    ...
    def save_protobuf(self, output_dir):
        ...
        Args:
            output_dir (str): the testing_output directory to save protobuf files.
        """
        logger = logging.getLogger(__name__)
    ...
    def __call__(self, inputs):
        ...
        input/testing_output format. See details about the format at :doc:`/tutorials/models`.
        ...
        on detectron2 in order to convert to detectron2's testing_output format.
        """
