...
class Caffe2MetaArch(Caffe2Compatible, torch.nn.Module):
    ...
    def encode_additional_info(self, predict_net, init_net):
        """
        Save extra metadata that will be used by inference in the testing_output protobuf.
        """
        pass
    ...
    def forward(self, inputs):
        ...
        Returns:
            tuple[Tensor]: testing_output tensors. They will be the outputs of the
    ...
    def get_outputs_converter(predict_net, init_net):
        ...
        Where
            ...
            * c2_results (dict[str, Tensor]): the caffe2 testing_output format,
                corresponding to the outputs of the :meth:`forward` function.
            * detectron2_outputs: the original testing_output format of the meta arch.
