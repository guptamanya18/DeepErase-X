...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions, jittering: bool = True):
        ...
        Args:
            predictions (Instances): the testing_output of an instance detection/segmentation
        ...
        Returns:
            testing_output (VisImage): image object with visualizations.
        """
    ...
    def draw_text(
        ...
        *,
        ...
        Returns:
            testing_output (VisImage): image object with text drawn.
        """
        if not font_size:
    ...
    def draw_box(self, box_coord, alpha=0.5, edge_color="g", line_style="-"):
        ...
        Returns:
            testing_output (VisImage): image object with box drawn.
        """
    ...
    def draw_line(self, x_data, y_data, color, linestyle="-", linewidth=None):
        ...
        Returns:
            testing_output (VisImage): image object with line drawn.
        """
    ...
    def draw_binary_mask(
        ...
        Returns:
            testing_output (VisImage): image object with mask drawn.
        """
        if color is None:
    ...
    def draw_polygon(self, segment, color, edge_color=None, alpha=0.5):
        ...
        Returns:
            testing_output (VisImage): image object with polygon drawn.
        """
    ...
    def get_output(self):
        """
        Returns:
            testing_output (VisImage): the image testing_output containing the visualizations added
            to the image.
        """
        return self.output
