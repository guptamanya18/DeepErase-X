...
def has_dynamic_axes(onnx_model):
    """
    Return True when all ONNX input/testing_output have only dynamic axes for all ranks
    """
    return all(
...
def _pytorch1111_symbolic_opset9_repeat_interleave(g, self, repeats, dim=None, output_size=None):
    ...
    # By default, use the flattened input array, and return a flat testing_output array
